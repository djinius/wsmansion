...
define 독백NVL = Character(None, ctc_position = 'nestled-close', kind=nvl, what_color='#700')
...
define 엘리NVL = Character(None, color="#FFDF01", image="엘리", ctc_position = 'nestled-close', kind=nvl, what_font="Danjo-bold-Regular.otf", what_outlines=[(1, "#000")])
