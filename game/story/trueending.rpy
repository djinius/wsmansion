label trueEnding:
    ...
    # 엘리 (놀람, 실눈 웃음, 미소)
    엘리 눈썹놀람 입미소 "실은 이번엔 저도 당신을 돕고 싶었답니다."
    ...
    "석양을 가리는 구름이 떨리고, 수풀이 떨리는 기척이 느껴질 때마다 알 수 있었어요."
    "저와 이 저택에 관한 이야기가 몇몇 이들에 의해 세상에 퍼진 지 꽤 되었고, 일부는 직접 찾아오기도 했으며,"
    "특별히 멍청한 이들은 돌이 되어버렸다는 걸요."
    "그러거나 말거나 전 신경도 쓰지 않았답니다."
    "저는 금방 잊히고 말 시시한 괴담 속 유령이자, 세상이라는 한 연극 속 조연일 뿐."
    "누군가 구해줄 거란 희망은, 희뿌예지는 과거의 기억과 함께 버린 지 오래였어요."
    ...
    "사실은 제 목이 꺾이더라도 누군가 제개 와주길 바랬으면서, 참 제멋대로죠."
