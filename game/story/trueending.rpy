label trueEnding:
    ...
    엘리 "그리고 몸이 조각상이 되는 불상사는 없을 거랍니다….\n…어리석은 제 가족과는 다르게 말이에요."

    # 엘리 (행복, 웃음, 미소)
    엘리 눈썹행복 눈웃음 입미소 "이미 당신도 저처럼 저택과 동화된 지 오래라,\n무리만 하지 않으신다면 그 새들처럼 굳지는 않을 거예요, 후훗."

    # 엘리 (음영 on, 보통, 사백안, 무표정)
    엘리 눈썹보통 눈사백안 입무표정 음영 "{font=Danjo-bold-Regular.otf}그러니까 빨리 제 눈앞에서 꺼져버리세요. 제 마음이 변하기 전에.{/font}"
    ...
    엘리NVL "저와 이 저택에 관한 이야기가 몇몇 이들에 의해 세상에 퍼진 지 꽤 되었고," 
    엘리NVL "일부는 직접 찾아오기도 했으며,"
    엘리NVL "특별히 멍청한 이들은 돌이 되어버렸다는 걸요."
    엘리NVL "그러거나 말거나 전 신경도 쓰지 않았답니다."
    엘리NVL "저는 금방 잊히고 말 시시한 괴담 속 유령이자, 세상이라는 연극의 조연일 뿐."
    ...
    엘리NVL "너무 오랜만에 어리광을 부리다 보니 익숙하지 않기도 했지만," 
    엘리NVL "일부러 모질게 군 것도 없잖아 있었어요."
    ...
    엘리 눈썹웃음 눈웃음 입미소 음영있음 "…그래서, 일부러 당신을 죽였어요."
    엘리 "적어도 당신의 영혼은 이곳에 남아 떠돌 수 있게 말이에요."
    엘리 "이곳에 오래 살다 보니, 제 오래 전 기억을 되살리진 못해도\n타인의 기억을 어느 정도 잠재우는 법도 터득한 참이었고요."
    엘리 눈실눈웃음2 "그걸 반복하고, 또 반복하며, 몸도 영혼도 저택과 하나가 되는 거예요."
    엘리 눈실눈웃음1 "우리가 함께 잠들 수 있으면 좋겠어요. 영원히 행복한 둘만의 꿈속에서."
