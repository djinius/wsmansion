label part1:
    ...
    독백 "바깥부터 내부까지, 고풍스러운 걸 넘어 과거의 유물 같은 곳이다."
    ...
    독백 "언뜻 수수해 보이는 원피스를 바탕으로 적당한 포인트를 주었는데, 고전 흑백 영화에서나 나올 법한 비주얼에도 전혀 촌스럽지 않았다."
    ...
    독백 "…대답할 길이 없었다."
    독백 "여기에 어떻게 왔는지, 심지어 내가 누군지 조차 모른다. 너무 단순해서 설명할 수 없는 처지를 과연 누가 믿어주겠는가."
    # 소녀? (보통, 웃음, 미소)
    # 소녀? (보통, 웃음, 미소)
    아비게일처음 미소 "음…무언가 말로는 못 할 사정이 있으신 것 같은데, 맞나요?"
    독백 "그러자, 소녀는 내게 의심의 눈초리 대신 따스한 미소를 건네주었다."
    독백 "고개를 끄덕였다. 소녀의 미소가 더욱 밝아졌다."
    # 소녀? (행복, 실눈 웃음, 큰 웃음
    ...
    독백 "나는 괜찮다는 의미로 고개를 저으며 멋쩍은 미소를 지었다."
    독백 "의심받아도 모자랄 상황에 환대라니, 이렇게 좋을 수가…."
    ...
    독백 "소녀의 삐죽하고 날카로운 덧니가 반짝이고, 빈 찻잔과 소녀의 모습이 눈앞에 아른거렸다."
    # 배경: 검은 화면
    ...
    독백 "부끄러워 얼굴을 붉히는 기색도 없이 다시 신비로운 분위기로 돌아간 걸로 보아, 콜라도 그렇고 제 나이대에 맞게 장난을 좋아하는 편인가, 생각했다."
    ...
    독백 "다시 엘리가 떠난 걸 확인했으니, 이번엔 무언가, 무언가 단서를 찾아야만 한다."
...
label investigateTable:
    ...
    독백 "아무 페이지나 펼쳐 보았다, 으극, 역시 영어라 그런지 읽질 못하겠다."
    ...
    독백 "확실히 예쁜 꽃이다. 그런데 어째 안뜰과는 달리 저택 내부에선 화분 하나 본 적이 없다."
...
label investigateRefrigerator:
    ...
    독백 "나는 높은 확률로 엘리의 ‘희생자’들이 보관되어 있을 곳을 향했다."
