label part1:
    ...
    # 소녀? (보통, 웃음, 미소)
    아비게일처음 눈썹보통 눈웃음 입미소 "많이 기다리셨죠, 손님 응대는 정말 오랜만이라서요."
    ...
    # 소녀? (난처, 실눈 웃음, 큰 웃음)
    아비게일처음 눈썹난처 눈실눈웃음1 입웃음 "푸후훗, 아, 죄송, 죄송해요. 그렇게까지 반응이 격할 줄은 몰라서."
    ...
    아비게일처음 눈썹보통 눈웃음 입무표정 "그럼, 실례가 아니라면 여기엔 무슨 용건이신지 설명을 부탁드려도 될까요."
    독백 "…대답할 길이 없었다."
    ...
    # 소녀? (행복, 실눈 웃음, 큰 웃음
    아비게일처음 눈썹행복 눈실눈웃음 입웃음 "후훗, 그래도 너무 걱정하지는 마세요. "
    ...
    # 소녀? (난처, 놀람, 무표정)
    아비게일처음 눈썹난처 눈미카놀람 입무표정 "무슨 일이시죠? 어디 다치기라도 하신 건가요?"
    ...
    # 소녀? (행복, 실눈 웃음, 큰 웃음)
    아비게일처음 눈실눈웃음1 입웃음 "상황이 딱 봐도 흡혈귀잖아요, 흡혈귀. 크와앙!"
    ...
    # 엘리 (행복, 웃음, 미소)
    아비게일처음 눈썹행복 눈웃음 입미소 "그럼 다시, 지금까지의 실례를 무릅쓰고, 처음 뵙겠습니다."
    hide 아비게일처음
