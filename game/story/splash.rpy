...
label splashReplay:
    ...
    독백 "내가 {i}살던{/i} 집일 리가 없었다. 아무리 기억을 잃었다지만, 그렇다 해도 분명 어느 부잣집 소유의 여름 별장일 터."
    ...
    독백 "그럼에도 이렇게까지 깔끔할 수 있다는 사실에 또 한 번 놀랐다."
    독백 "부잣집일 테니 청소 업체가 있을 테고, 다녀가면서 문단속을 깜박했을까."
    독백 "아니, 전문적인 업체에서 애초에 그런 기본적인 실수를 저지를 리가 없었다."
    독백 "그렇게 생각하니 소름이 돋았다. 도움보다는 한시 빨리 이곳에서 빨리 나가고 싶은 마음이었다."
