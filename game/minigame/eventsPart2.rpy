...
label mirrorComplete:
    ...
    # 엘리 (보통, 사백안, 무표정, 눈물)
    엘리 눈썹보통 눈사백안 입무표정 눈물 "아니면 이런 저의 처지를 외면하시겠다는 건가요."
    ...
    # 엘리 (보통, 사백안, 무표정, 눈물) 
    엘리 "가만히만 있지 말고, 입이 살았으면 뭐라도 말해 보란 말이에요…!"
    ...
    # 엘리 (슬픔, 사백안, 무표정, 눈물 - 오열)
    엘리 눈썹슬픔 눈사백은 입무표정 눈물 "그, 그럼 적어도, 적어도 다시 돌아와 주겠다고 약속만 해 줘요. 네? 문은 언제든지 열려 있어요."
    엘리 "이렇게 부탁할게요. 절 여기다가 혼자 두고 간다고만 말하지 말아줘요. 잊히기 싫어요. 세상에서도, 당, 당신에게서도."
    ...
    엘리 "{b}우리는 한 쌍처럼 완벽했는데, 왜 우리 모두 무너져야만 하냐고요!{/b}"
