...
label mirrorComplete:
    ...
    엘리 "모두가 공포에 질려 도망치는 가운데 저는 영문을 모르는 와중 홀로 남겨졌어요."
    ...
    # 엘리 (행복, 웃음, 미소, 눈물)
    엘리 눈물 "전부 당신 덕분이에요. 다시 내 삶에 따스한 빛깔이 돌아온 건."
    엘리 "말로 다 표현할 수 없을 만큼, 정말, 정말로 감사해요."
    ...
    독백 "나는 지금 외로움에 미친 나머지 자신만의 세상에 빠져,\n내게 배신당했다고 굳게 믿는 저택의 원령을 마주하고 있었다."
    ...
    독백 "내 일갈에 털썩하고 자리에 주저앉는 엘리."
    독백 "나도 잠시 흥분했지만, 진정되면 다시 나가는 방법을 정중히 물어보려 했다."
    독백 "그러자 생기 없는 차가운 감촉이 내 손에 닿았다. 엘리였다."
    독백 "엘리의 소름 끼치는 웃음은 울음으로, 절규로…."
    독백 "……그리고 쩍쩍 갈라지는 괴성으로 변했다."
    ...
    엘리 "그 쓰라림을 당신이 알 턱이 없죠. 그러니 절 사랑한다고,"
    엘리 "소중히 아낀다고 말은 할 수 있을지언정 돌아간 다음 깨끗이 잊고 말겠지요."
    엘리 "선의로 포장된 이기적인 거짓말을 고하고도 떳떳할 수 있을 테죠."
    엘리 "그래도 전 당신을 원망하지 않으려 했어요. 그러고 싶지 않았어요."
    엘리 "당신 덕분에, 저주와도 같은 이 영원함 속에서 행복은 다시 피어났으니까요."
    엘리 "하지만 그 행복은 오직 서로를 통해서만 얻을 수 있어요." 
    엘리 "당신도 그걸 느꼈잖아요. 그렇다면, 대체 왜 돌아가시려는 거예요?"
    엘리 "모두의 알량한 변덕을 채워주지 못한 것 빼고 제게 무엇이 부족했나요?"
    엘리 "왜 모두 일말의 동정심도 없이 날 망각의 늪에 빠트리려 하죠?"
    엘리 "심지어 그대마저."
    엘리 "믿었던 그대마저, 사실은 저처럼, 아직도 슬픔에 무너지기 일보 직전이면서."
    엘리 "보이지만 않을 뿐 우린 같은 상처를 공유했다 믿었는데."
