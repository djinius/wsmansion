...
label lockStory:
    ...
    독자5 "나 이 작가 글 더는 못 봐주겠다, \n문장력부터 필체에 현실반영이지겹고감정선이고구마먹다암세포걸려뒤지겠네작가새\n끼뇌세포가살아있는건지상차하자가나다"
...
label mirrorComplete:
    ...
    독백 "날개를 편 채 돌처럼 굳어버린 작은 새 모양 조각상들은, \n필시 얼마 전까지만 해도 {i}살아{/i} 있었다."
    독백 "그 증거로 두 뾰족한 주둥이 사이엔 사과 조각들이 박혀 있었다. \n다른 누구도 아닌 엘리가 잘라 놓은 사과 조각들이."
    ...
    엘리 "취미 생활이에요. 예쁘게 굳었죠? 당신께도 보여드리고 싶어서…."

    # '나'
    나 "정원의 저 조각상들, 어떻게 된 건지 제대로 설명하는 게 좋을 거야."
    ...
    나 "그리고 이걸 왜 나한테 보여주는 건지도, 제대로 설명하는 게 좋을 거야."

    # 엘리 (보통, 웃음, 무표정)
    엘리 눈썹침울 눈웃음 "하아, 전 사람을 조각상으로 만들기 위해 가지고 놀 정도로 영악하진 않아요."
    엘리 눈썹보통 "애초에 조각상이 된 모든 이들이, 죄가 없다고 어떻게 확신하는 거죠?"
    ...
    엘리 "이 새들도 그걸 기념하기 위해 만든 거에요."
    엘리 "우리의 새로운 시작과, 앞으로도 계속될 저택에서의 나날들을 위해서."

    독백 "{i}아니,{/i} 마음 같아서는 저 영악한 마녀를 끓는 솥에다 담가버리고 싶었다."
    독백 "채 날개를 펴지도 못한 채 굳어버린 새들의 날카로운 비명이 머릿속에서 메아리치는 것 같았다."
    독백 "그것은 까마귀들의 울음소리와도 같아서, 내게 닥칠 끔찍한 미래를 예언하고 있었다."

    # 엘리 (행복, 실눈 웃음, 미소)
    엘리 눈물없음 "어때요, 정말 사랑스럽지 않나요?"
