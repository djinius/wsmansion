...
label mirrorComplete:
    ...
    # 엘리 (행복, 실눈 웃음, 미소)
    엘리 눈실눈웃음1 "처음엔 그리 내키진 않았어요. 불청객은 사양이니까요." 
    엘리 "근데 당신의 모든 희망을 내려놓은 눈빛이 마음에 들더군요,\n본의 아니게 저택에 영영 갇힌 운명의 어느 소녀처럼 말이죠."
    엘리 "그리고 어째서일까, 당신과 함께하는 실없는 일상이이 반복될수록,"
    ...
    # 엘리 (행복, 웃음, 미소)
    엘리 눈웃음 "당신이 있었기에 제가 여기 존재할 이유를 다시 찾아낼 수 있게 된 거예요."
    ...
    # 엘리 (행복, 사백안, 미소, 눈물)
    엘리 "그러니 굳이 다시 떠날 필요도 없답니다."
    엘리 눈실눈웃음1 "당신이 좋아하는 유치한 동화 속 왕자님과 공주님처럼,\n여기서라면 영원히 둘이 행복하게 살 수 있으니까요."
    ...
    # ‘나’ 
    나 "그래, 알겠어. 대신 마지막으로 이거 하나만 확실히 하자." 
    나 "이 저택도, 너와의 추억도, 모두 소중해."
    나 "하지만 난 너만을 위한 장난감 새도, 오래된 가족사진 속 배경도 아니라고!"
    나 "그러니까, 제발 - "

    # 엘리 퇴장
    hide 엘리 with dissolve

    독백 "자리에 주저앉는 엘리를 두고 일단 상황을 진정시키려 했다."
