...
label mirrorComplete:
    ...
    독백 "저택에 오고 난 뒤로 느껴졌던 그 모든 위화감이 한데 모여,\n내가 마지막으로 본 광경과 함께 소름 끼치는 추측을 뒷받침해주고 있었다."
    ...
    독백 "저택에 온 뒤로 나에게서 무언가 감추는 듯한 엘리의 행동거지."
    ...
    독백 "그로테스크하게 아직 꿈틀대는 새를 보고도 실실 웃는 엘리."
    독백 "그 다음 엘리의 입에서 나온 말은 일체의 변명도 아닌,\n엘리가 내게서 숨기고 있었던 충격적인 비밀이었다."

    엘리 "뭐, 별건 아니고 저택의 기현상을 이용한 취미 생활이에요. 예쁘게 굳었죠?" 
    엘리 "당신께도 보여드리고 싶단 생각은 했지만… 제 예상보다 빨리 찾아내셨군요."

    # '나'
    나 "그렇다면 정원의 저 조각상들도 어떻게 된 건지 제대로 설명하는 게 좋을 거야."
    ...
    나 "제대로 설명하는 게 좋을 거야. 이 저택은 다 뭐고, 저 사람들은, 나는…."

    # 엘리 (보통, 웃음, 무표정)
    엘리 눈썹침울 눈웃음 "하아, 우선, 전 사람을 조각상으로 만들기 위해 가지고 놀 정도로 영악하진 않아요."
    ...
    # 엘리
    엘리 "말장난 아니에요. 저택 지하에서 무언가 불경한 일이 벌어지고 있었던 건 확실하거든요."
    엘리 눈썹행복 눈웃음 "엘리엇 가문이 세일럼, 매사추세츠에서 쫓겨나 이곳으로 몸을 옮긴 이유와도 관련 있을 터죠."
    엘리 "정확히 무슨 일이었는지는 저도 몰라요.\n당시 어렸던 저만 빼고 암암리에 진행되던 일이었으니."
    엘리 눈썹보통 "그렇게 저에게는 평화로운 일요일 오후, 가족들에겐 비밀스런 집회가 실패했던 날,"
    ...
    독백 "채 날개를 펴지도 못한 채 굳어버린 새들의 날카로운 마지막 숨결이 머릿속에서 메아리쳤다."
