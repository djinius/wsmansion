...
label mirrorComplete:
    ...
    나 "두 뾰족한 주둥이 사이엔 엘리가 잘라 놓은 사과 조각들이 박혀 있었다."
    나 "저택에 오고 난 뒤로 느껴졌던 그 모든 위화감이 한데 모여, 매우 소름 끼치는 추측과 함께 맞아떨어지기 시작했다."
    ...
    나 "하나같이 우리를 등진 채 도망치려는 듯한 조각상들."
    나 "배경: 저택 외관"
    나 "대한민국에, 이런 곳에 있을 리 없는 괴담 속 대저택까지."
    ...
    나 "생각해보니 여기에 온 첫날 빼고 저녁놀이 진 것을 본 적이 없다."
    ...
    # 엘리 (행복, 실눈 웃음, 미소)
    엘리 "사실 그리 내키진 않았지만, 모든 희망을 내려놓은 눈빛이 마음에 들었거든요." 
    ...
    나 "{i}아니,{/i} 마음 같아서는 저 영악한 마녀를 끓는 솥에다 담가버리고 싶었다."
    ...
    나 "저건 내가 아는 엘리의 모습이 아니었다."
    나 "나는 지금 외로움에 미친 나머지 자신만의 세상에 빠져, 내게 배신당했다고 굳게 믿는 저택의 원령을 상대해야만 했다."

    # 엘리 (보통, 사백안, 무표정, 눈물) 
    엘리 "가만히만 있지 말고, 입이 살았으면 뭐라도 말해 보란 말이에요…!"

    나 "분노한 엘리가 내 쪽으로 성큼성큼 다가오기 시작했다."
    나 "눈앞이 아찔해졌다, 이번엔 진짜 마지막이라는 생각이 들었다."
    나 "그러자 신기하게도 오히려 마음이 편안하고 침착해지는 것이었다."
    나 "심호흡을 했다. 생각해 보니 나 또한 엘리에게 미처 전하지 못한 것들이 있었다. " 
    나 "아니, 전해야만 했다."
    ...
    # 엘리 (침울, 감은 눈, 미소)
    엘리 "그랬군요. 맞아요, 우리는 서로 함께였기에, 그 사실을 확인하며 온기를 나누었어요."
    ...
    # 엘리 (슬픔, 사백안, 무표정, 눈물 - 오열)
    엘리 "그, 그럼 적어도, 적어도 다시 돌아와 주겠다고 약속만 해 줘요. 네? 문은 언제든지 열려 있어요."
    ...
    나 "내가 거절의 표시로 고개를 젓자, 쩍쩍 갈라지는 나무처럼 목소리가 일그러지던 엘리는 자리에서 그대로 무너지고 말았다."
    ...
    나 "나는 악을 쓰며 소리쳤다."
    나 "이제는 빨리 나가고 싶다기보단 엘리와의 마지막 작별에서도 후회를 남기고 싶지 않다는 마음이었다."
    나 "그리고 그런 나의 진심은 이제 아무 상관 없다는 듯이, 철판을 긁어대는 것 같은 웃음소리가 들려왔다."
    나 "소름 끼치는 감촉이 내 손에 닿았다."
    ...
    나 "내가 엘리에게? 엘리가 나에게?"
    나 "나는 진심을 토했다고 생각하는데, 이젠 막상 누가 거짓말쟁이인지 헷갈린다."
