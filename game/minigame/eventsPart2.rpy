...
label lockStory:
    ...
    독백 "무엇보다 중요한 건, \n나만을 위해 만들어진 세상에서 나는 완벽히 자유로울 수 있었다."
...
label mirrorComplete:
    ...
    독백 "저택에 오고 난 뒤로 느껴졌던 그 모든 위화감이 한데 모여, \n매우 소름 끼치는 추측과 함께 맞아떨어지기 시작했다."
    ...
    독백 "뒤로 물러서려 했지만, \n안뜰을 함부로 넘어간 이들과 같은 최후를 맞고 싶지 않았다."
    ...
    # 엘리 (보통, 눈 감음, 무표정)
    엘리 눈썹보통 눈실눈웃음1 "째깍, 째깍, 시계바늘은 쉼 없이 움직이지만, \n감아놓은 태엽은 완전히 풀리지 않더군요."
    ...
    # 엘리 (행복, 눈 감음, 미소)
    엘리 입미소 "제 유년기가 어땠는지, 가족들의 모습은 어땠는지, \n이젠 아무리 애써도 기억나지 않아요."
    ...
    # 엘리 (놀람, 사백안, 미소, 눈물 - 오열)
    엘리 눈썹놀람 눈사백안 입미소 눈물 "그, 그럼 적어도, 적어도 다시 돌아와 주겠다고 약속만 해 줘요. \n네? 문은 언제든지 열려 있어요."
    # 엘리 (침울, 사백안, 무표정, 눈물 - 오열)
    ...
    독백 "내가 고개를 젓자, \n쩍쩍 갈라지는 나무처럼 목소리가 일그러지던 엘리는 자리에서 그대로 무너지고 말았다."
