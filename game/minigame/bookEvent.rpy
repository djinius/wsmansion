...
label makeUpStory:
    ...
    독백 "여기서 삶을 포기하러 온 건 맞지만, 일면식도 없는 누군가 살고 있는 집이었다는 점."
    독백 "…그 누군가가 다른 누구도 아닌 순수한 어린아이라는 점에서 가책을 느꼈다."
    독백 "심지어 보모조차 없어서, 불쌍해 보이니 적당히 놀아주다 눈치껏 빠져나올 생각이었다."
