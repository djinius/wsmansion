...
label makeUpStory:
    ...
    독백 "소녀의 어려 보이는 외모만 보고 일부러 수준을 낮췄는데, 부잣집 영애답게 만만히 볼 상대는 아니었던 모양이다."
...
label suitFitStory:
    ...
    독백 "내가 옴짝달싹 못 하는 사이, 누군가 결국 참다못해 강제로 방문을 열고 들어왔다."
    ...
    독백 "어째서인지 제 인상을 더 찌푸리며 혀를 차는 엘리는 덤이었다."
...
label birdFeedStory:
    ...
    독백 "{i}끝{/i}을 찾아서 온 저택에 아련함과 행복함이 감돌았다. 나는 나지막이 입을 열었다."
