...
label makeUpStory:
    ...
    # 엘리 (보통, 눈 감음, 무표정)
    엘리 눈썹보통 눈실눈웃음1 입무표정 "그쯤 하시고 책 이리 넘기시죠."

    #‘나’ 
    나 "이렇게 혼자 아무것도 안 하고 있으면 심심하잖아."
 
    # 엘리 (난처, 침울, 무표정,)
    엘리 눈썹난처 눈침울 "심심한 건 제가 아니라 당신이겠죠."
    ...
    #엘리 (난처, 실망(실눈), 무표정)
    엘리 눈썹난처 눈실눈웃음1 "‘사랑의 키스로 왕자님의 병을 낫게 했다’, 뭐 그런 내용이 아닐까 싶습니다만."
    ...
    나 "어려 보이는 외모만 보고 일부러 수준을 낮췄는데, 부잣집 영애답게 만만히 볼 상대는 아니었던 모양이다."
...
label suitFitStory:
    ...
    나 "내가 옴짝달싹 못 하는 사이, 결국 참다 못해 방문을 제치고 들어온 누군가."
    ...
    나 "남성용 양복이라 그런지 가슴 부위가 특히 답답하고 조였다. 이유는 모르겠지만 인상을 더 찌푸리며 혀를 차는 엘리는 덤이었다."
