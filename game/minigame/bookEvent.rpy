...
label makeUpStory:
    ...
    # 엘리 (침울, 침울, 무표정)
    엘리 눈썹침울 눈침울 "심심한 건 제가 아니라 당신이겠죠."
...
label birdFeedStory:
    ...
    독백 "일상에서는 남들과 부딫히며 계속되는 불협화음을 만들었지만,\n이곳에서는 편안하게 나 본연의 색이 물감이 되어 한 폭의 그림에 섞일 수 있었다."
    독백 "하지만, 동시에 알 수 있었다."
    독백 "과거에서 바로 날아온 것 같은 이 저택에서 나는 엘리와는 다르게 어울리지 않는다는 사실을."
    독백 "이곳은 집처럼 편안하지만, 그럼에도 내 {i}집{/i}은 아니라는 생각을 떨쳐낼 수 없었다."
    독백 "여행을 떠나는 것처럼 팔을 활짝 벌린 조각상들을 보며,\n문득 {i}사람은 여행을 떠나야만 집의 소중함을 알게 된다{/i}는 어느 오랜 경구가 떠올랐다."
    ...
    독백 "그리고 다시 하늘로 날아가기 위해 날갯짓하는 새들도…."
