    ...
    if isQuickVisible():
        ...
        imagemap:
            ...
            hotspot (  0, 0, 60, 60):
                ...
                if _in_replay:
                    tooltip ["대사록(L)", "지나간 대사를 다시 열람합니다.", (1920 - 60 * 8 - 30, 1020), (.5, 1.)]
                else:
                    tooltip ["대사록(L)", "지나간 대사를 다시 열람합니다.\n대사록의 대사를 클릭해 해당 시점으로\n되돌아갈 수 있습니다.", (1920 - 60 * 8 - 30, 1020), (.5, 1.)]

            if not _in_replay:
                hotspot ( 60, 0, 60, 60):
                    action Show('inventory')
                    sensitive myInventory
                    tooltip ["소지품(I)", "소지품을 확인합니다.", (1920 - 60 * 7 - 30, 1020), (.5, 1.)]
            ...
            hotspot (240, 0, 60, 60):
                action Skip()
                tooltip ["빠르게 진행", "대사를 빠르게 진행합니다.", (1920 - 60 * 4 - 30, 1020), (.5, 1.)]
            hotspot (300, 0, 60, 60):
            ...
            if not _in_replay:
                hotspot (360, 0, 60, 60):
                    ...
                    tooltip ["저장(S)", "현재 게임을 저장합니다.", (1920 - 60 * 2 - 30, 1020), (.5, 1.)]
            else:
                hotspot (360, 0, 60, 60):
            ...
            hotspot (420, 0, 60, 60):
                ...
                tooltip ["설정(P)", "화면 모드 및 음량, 기타 게임을 진행하기 위한\n편의사항을 설정합니다.", (1920, 1020), (1., 1.)]
            hotspot (480, 0, 60, 60):
                action HideInterface()
                tooltip ["숨기기(H)", "게임 인터페이스를 숨깁니다.", (1920, 1020), (1., 1.)]
